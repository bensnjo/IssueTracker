...
import static ke.go.kra.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import ke.go.kra.IntegrationTest;
import ke.go.kra.config.Constants;
import ke.go.kra.domain.User;
import ke.go.kra.repository.AuthorityRepository;
import ke.go.kra.repository.UserRepository;
import ke.go.kra.security.AuthoritiesConstants;
import ke.go.kra.service.UserService;
import ke.go.kra.service.dto.AdminUserDTO;
import ke.go.kra.service.dto.PasswordChangeDTO;
import ke.go.kra.service.dto.UserDTO;
import ke.go.kra.web.rest.vm.KeyAndPasswordVM;
import ke.go.kra.web.rest.vm.ManagedUserVM;
